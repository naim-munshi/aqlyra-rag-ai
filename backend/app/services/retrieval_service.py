...
def search_similar_chunks(
    ...
    active_query_vector = (
        ...
        else active_provider.embed_query(
            query.text
        )
    )

    validate_embedding_vector(
        vector=active_query_vector,
...
def score_specific_chunks(
    ...
    """
    Compute true dense cosine scores for a specific,
    tenant-scoped set of chunks.
    """
